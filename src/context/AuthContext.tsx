...
import { loginUser, registerUser } from "../lib/authApi"; // runtime functions
import type { LoginPayload, RegisterPayload, AuthResponse, UserData } from "../lib/authApi"; // type-only
import axiosClient from "../lib/axiosClient"; // For setting default headers
